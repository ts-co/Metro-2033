...
ITEM.desc = "A set of gear and clothing that is worn by Stalkers"
ITEM.price = 100
ITEM.model = "models/devcon/mrp/act/stalker.mdl"
ITEM.width = 2
ITEM.height = 2
ITEM.iconCam = {
...
ITEM.replacements = "models/devcon/mrp/act/stalker.mdl"
