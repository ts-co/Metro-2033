...
function SCHEMA:OnPlayerJoinClass(client, class, oldClass)
	local info = nut.class.list[class]
	...
	if (class and class.pay and class.pay > 0) then
		timer.Create("nutSalary"..client:UniqueID(), class.payTime or 300, 0, function()
			local pay = hook.Run("GetSalaryAmount", client, class) or class.pay
