...
SWEP.VElements = {
	["2012"] = { type = "Model", model = "models/arxweapon/2012kalash.mdl", bone = "p90_body", rel = "", pos = Vector(3.64, -1.56, 0.05), angle = Angle(0, 0, 90), size = Vector(0.699, 0.699, 0.699), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 0, [3] = 1, [4] = 1} },
...
SWEP.Gun = ("m9k_mrp_2012_scope") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Scoped Kalash 2012"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= Sound("ak-2012/shoot-1.wav")		-- Script that calls the primary fire sound
