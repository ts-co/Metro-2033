...
SWEP.VElements = {
	["padonok"] = { type = "Model", model = "models/arxweapon/podonok.mdl", bone = "sig_frame", rel = "", pos = Vector(0, 1.557, 0), angle = Angle(0, -92.338, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

SWEP.WElements = {
	["padonok"] = { type = "Model", model = "models/arxweapon/podonok.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.675, 1, -1.3), angle = Angle(178.83, 180, 0), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}

-- Variables that are used on both client and server
SWEP.Gun = ("m9k_mrp_padonak") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Lolife"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.IronAccuracy = .0175 -- has to be the same as primary.spread
