...
SWEP.VElements = {
	["revolver"] = { type = "Model", model = "models/arxweapon/revolver.mdl", bone = "Barrel Low", rel = "", pos = Vector(2.4, 6.5, 0), angle = Angle(180, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0, [2] = 1} },
...
SWEP.WElements = {
	["revolver"] = { type = "Model", model = "models/arxweapon/revolver.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.7, 1.7, 2.299), angle = Angle(-162.469, 180, 5.843), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0} }
}

SWEP.Gun = ("m9k_mrp_revolver_silenced") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Revolver Silenced"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Sound			= Sound("others/rev_shoot_s_1.mp3")		-- Script that calls the primary fire sound
...
SWEP.Primary.Spread		= .0475	--define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .009 -- has to be the same as primary.spread
