...
SWEP.VElements = {
	["2012"] = { type = "Model", model = "models/arxweapon/2012kalash.mdl", bone = "p90_body", rel = "", pos = Vector(3.64, -1.56, 0.05), angle = Angle(0, 0, 90), size = Vector(0.699, 0.699, 0.699), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 1, [2] = 0, [3] = 1, [4] = 0} },
...
SWEP.WElements = {
	["2012"] = { type = "Model", model = "models/arxweapon/2012kalash.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.675, 1, -0), angle = Angle(-12.858, 3.506, 180), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[2] = 0, [3] = 1, [4] = 0} }
}


SWEP.Gun = ("m9k_mrp_2012_scope_silencer") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Scoped & Silenced Kalash 2012"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Spread		= .0275	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
