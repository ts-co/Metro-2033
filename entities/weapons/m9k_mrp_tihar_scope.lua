...
SWEP.VElements = {
	["tihar"] = { type = "Model", model = "models/arxweapon/tihar.mdl", bone = "v_weapon.xm1014_Parent", rel = "", pos = Vector(0.518, 1.557, -1.558), angle = Angle(91, 90, 0), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0} }
}

SWEP.WElements = {
	["element_name"] = { type = "Model", model = "models/arxweapon/tihar.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0, 0), angle = Angle(-13.974, -4.466, 180), size = Vector(0.944, 0.944, 0.944), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 0} }
}

SWEP.Gun = ("m9k_mrp_tihar_scope") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Tihar Scope"		-- Weapon name (Shown on HUD)	
