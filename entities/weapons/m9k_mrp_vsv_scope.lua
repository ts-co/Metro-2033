...
SWEP.VElements = {
	...
	["vsv"] = { type = "Model", model = "models/arxweapon/vsv.mdl", bone = "Ak.Body.Dummy", rel = "", pos = Vector(-2.6, -0.5, 0), angle = Angle(0, 0, 92.337), size = Vector(0.899, 0.899, 0.899), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[1] = 2, [2] = 0, [3] = 1} }
}

SWEP.WElements = {
	["vsv"] = { type = "Model", model = "models/arxweapon/vsv.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0, 0.518, 0.699), angle = Angle(-5.844, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {[2] = 0, [3] = 1} }
}


SWEP.Gun = ("m9k_mrp_vsv_scope") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "VSV Scope"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Spread		= .045	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact) /default = .023
SWEP.Primary.IronAccuracy = .005 -- Ironsight accuracy, should be the same for shotguns /default = .013
