...
SWEP.Gun = ("m9k_mrp_gatling") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Gatling"		-- Weapon name (Shown on HUD)	
...
SWEP.Primary.Spread		= .23	-- Define from-the-hip accuracy 1 is terrible, .0001 is exact)
SWEP.Primary.IronAccuracy = .073 -- Ironsight accuracy, should be the same for shotguns
