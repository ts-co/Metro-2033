...
function SWEP:PrimaryAttack()
	...
	tr.endpos = self.Owner:GetShootPos() + ( self.Owner:GetAimVector() * 55 )
	tr.filter = self.Owner
	tr.mask = MASK_SHOT
	local trace = util.TraceLine( tr )
	
		if ( trace.Hit ) then
			self.Weapon:EmitSound(Sound("weapons/melee/Crowbar/Crowbar_hit-"..math.random(1,4)..".wav"))
...
if CLIENT then
	...
	killicon.Add( "weapon_hammer", "HUD/killicons/weapon_hammer", Color ( 255, 255, 0, 255 ) )
